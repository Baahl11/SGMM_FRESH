            ...
            <div className="mt-10 pt-10 border-t border-white/20">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="text-white">
                  ...
                  <div className="font-semibold mb-1">NOM-004 Completa</div>
                  <div className="text-sm text-white/70">Única con expediente médico legal</div>
                </div>
                <div className="text-white">
                ...
                <div className="text-white">
                  ...
                  <div className="font-semibold mb-1">WhatsApp Sin Costo</div>
                  <div className="text-sm text-white/70">Mensajes ilimitados gratis</div>
                </div>
              </div>
            </div>
          </div>
