...
import { ArrowLeft, Plus, Trash2, Loader2, Tag, DollarSign } from 'lucide-react'
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        throw new Error(error.message || 'Error creating promotion')
      }
      ...
      setError(error instanceof Error ? error.message : 'Error al crear la promoción')
    } finally {
      setLoading(false)
    }
  }

  if (loadingAuth || loadingTreatments) {
    return (
      <AppLayout>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-gray-600">Crea un paquete de tratamientos con precio especial</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="grid gap-6 lg:grid-cols-2">
            ...
            <Card className="bg-white shadow-sm border border-gray-200">
              <CardHeader>
                ...
                <CardDescription>Selecciona los tratamientos del paquete</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  {selectedTreatments.length === 0 ? (
                    <div className="text-center py-8 text-gray-500 border-2 border-dashed rounded-lg">
                      ...
                      <p className="text-sm">Selecciona tratamientos arriba</p>
                    </div>
                  ) : (
                    <div className="space-y-2">
                      {selectedTreatments.map(st => (
