...
export default function MessagingPage() {
  const [config, setConfig] = useState<NotificationConfig>({
    ...
    email_template: 'Estimado/a {patient_name}, le recordamos que tiene una cita médica programada para el {appointment_date} a las {appointment_time}. Consultorio UME López & López.',
    whatsapp_template: 'Hola {patient_name}! 👋 Recordatorio: Tienes cita médica el {appointment_date} a las {appointment_time}. Te esperamos en UME López & López 🏥',
    sendgrid_api_key: '',
    twilio_account_sid: '',
    twilio_auth_token: '',
    twilio_phone_number: '',
            ...
            <Card className="shadow-lg border-0 bg-white/70 backdrop-blur-sm">
              <CardHeader className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 rounded-t-lg">
                ...
                <CardDescription>
                  ...
                  Variables disponibles: {'{patient_name}'}, {'{appointment_date}'}, {'{appointment_time}'}
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-6 pt-6">
                <div className="space-y-4">
