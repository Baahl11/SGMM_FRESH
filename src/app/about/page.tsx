...
import { Mail, Phone, MapPin, Globe, Heart, Users, Award, Clock, Info } from "lucide-react";
    ...
    <div className="space-y-8 p-6 bg-gradient-to-br from-blue-50/50 to-indigo-50/50 min-h-screen">      
      ...
      <div className="bg-white rounded-xl p-8 shadow-sm border border-blue-100 text-center">
        ...
        <p className="text-lg text-gray-600 max-w-3xl mx-auto">
          Sistema de Gestión Médica Moderna (SGMM) - Desarrollado por especialistas en tecnología médica
        </p>
      </div>      {/* Main Info Cards */}
