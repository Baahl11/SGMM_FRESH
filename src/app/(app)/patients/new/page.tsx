...
export default function NewPatientPage() {
  ...
  const handleMultiTreatmentSubmit = async (data: any) => {
    ...
    try {
      // Call with patientId and data as separate parameters
              ...
              <TabsContent value="single" className="space-y-6">
                <div className="text-center py-4">
                  <div className="inline-flex items-center gap-2 bg-blue-50 text-blue-700 px-4 py-2 rounded-lg">
                    ...
                    <span className="font-medium">Registro de Nuevo Paciente</span>
                  </div>
                  <p className="text-gray-600 mt-2">
                    Registra un nuevo paciente. Los tratamientos y citas futuras son opcionales.
                  </p>
                </div>
