...
const MessagingPage: React.FC = () => {
  ...
  const loadLogs = async () => {
    try {
      // Obtener logs de un endpoint existente o usar datos mock hasta implementar
      console.log('🔄 Loading messaging logs...');
      
      // Por ahora usar datos mock hasta implementar el endpoint correcto
