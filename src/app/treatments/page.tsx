              ...
              <CardContent className="p-4 space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-blue-50 rounded-lg p-3">
                    ...
                    <p className="font-bold text-blue-900">${treatment.costo_unitario.toFixed(2)}</p>
                  </div>
                  <div className="bg-green-50 rounded-lg p-3">
                    ...
                    <p className="font-bold text-green-900">${treatment.precio.toFixed(2)}</p>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-amber-50 to-yellow-50 rounded-lg p-3 border border-amber-200">
                  ...
                  <p className="font-bold text-amber-900">
                    ${(treatment.precio - treatment.costo_unitario).toFixed(2)} 
                    <span className="text-sm font-normal text-amber-700 ml-2">
                      ({((treatment.precio - treatment.costo_unitario) / treatment.precio * 100).toFixed(1)}%)
                    </span>
                  </p>
                </div>
